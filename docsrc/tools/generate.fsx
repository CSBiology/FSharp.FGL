...
let website = "https://CSBiology.github.io/FSharp.FGL/"
...
let info =
  [ "project-name", "FSharp.FGL"
    "project-author", "HLWeil,WalternativE"
    "project-summary", "Functional graph-library written in F#"
    "project-github", "https://github.com/CSBiology/FSharp.FGL"
    "project-nuget", "http://nuget.org/packages/FSharp.FGL" ]
...
let referenceBinaries = 
        [ 
        __SOURCE_DIRECTORY__ + "/../../src/FSharp.FGL/bin/Release/net47/FSharp.FGL.dll"     
        ]
    
let libDirs = 
    [ 
        __SOURCE_DIRECTORY__ + "/../../src/FSharp.FGL/bin/Release/net47/"
    ]
...
let buildReference () =
    ...
    RazorMetadataFormat.Generate( 
        ...
        sourceRepo = "https://github.com/CSBiology/FSharp.FGL/tree/master/",
