...
module Louvain =                   
    ...
    let private louvainMethod (g1:ArrayAdjacencyGraph<'Vertex,'Label,float>) (randomized:bool) (modularityIncreaseThreshold: float) : (float)*(ArrayAdjacencyGraph<'Vertex,'Label*int,float>) = 
